import {getRPC as $8TnEt$getRPC, methods as $8TnEt$methods} from "@telestai-project/telestai-rpc";
import $8TnEt$telestaiprojecttelestaikey from "@telestai-project/telestai-key";
import $8TnEt$telestaiprojecttelestaisigntransaction from "@telestai-project/telestai-sign-transaction";
...
(0, $8TnEt$telestaiprojecttelestaisigntransaction).sign; //"Idiocracy" but prevents bundle tools such as PARCEL to strip this dependency out on build.
...
async function $67c46d86d9d50c48$export$322a62cff28f560a(WIF, wallet, onlineMode) {
    const privateKey = (0, $8TnEt$telestaiprojecttelestaikey).getAddressByWIF(wallet.network, WIF);
    const result = {};
    ...
    const signedHex = (0, $8TnEt$telestaiprojecttelestaisigntransaction).sign(wallet.network, rawHex, UTXOs, privateKeys);
...
async function $2767f256fef0b24e$export$df96cd8d56be0ab1(wallet, addresses) {
    ...
    const balance = await wallet.rpc((0, $8TnEt$methods).getaddressbalance, params);
...
const $938d55385eb2df3f$var$URL_TELESTAI_MAINNET = "https://tls-rpc-mainnet.telestai.io/rpc";
const $938d55385eb2df3f$var$URL_TELESTAI_TESTNET = "https://tls-rpc-testnet.telestai.io/rpc";
class $938d55385eb2df3f$export$bcca3ea514774656 {
   ...
   */ sweep(WIF, onlineMode) {
    ...
    async init(options) {
        ...
        let url = $938d55385eb2df3f$var$URL_TELESTAI_MAINNET;
        //VALIDATION
        ...
        if (options.network === "tls-test") url = $938d55385eb2df3f$var$URL_TELESTAI_TESTNET;
        ...
        this.rpc = (0, $8TnEt$getRPC)(username, password, url);
        this._mnemonic = options.mnemonic;
        //Generating the hd key is slow, so we re-use the object
        const hdKey = (0, $8TnEt$telestaiprojecttelestaikey).getHDKey(this.network, this._mnemonic);
        const coinType = (0, $8TnEt$telestaiprojecttelestaikey).getCoinType(this.network);
        const ACCOUNT = 0;
        ...
        while(doneDerivingAddresses === false){
            ...
            const tempAddresses = [];
            for(let i = 0; i < 20; i++){
                const external = (0, $8TnEt$telestaiprojecttelestaikey).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/0/${this.addressPosition}`);
                const internal = (0, $8TnEt$telestaiprojecttelestaikey).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/1/${this.addressPosition}`);
    ...
    async hasHistory(addresses) {
        ...
        const asdf = await this.rpc((0, $8TnEt$methods).getaddressbalance, [
            obj,
            includeAssets
        ]);
        //@ts-ignore
    ...
    async getHistory() {
        ...
        const deltas = this.rpc((0, $8TnEt$methods).getaddressdeltas, [
            {
                addresses: addresses,
                assetName: assetName
            }
    ...
    async getMempool() {
        const method = (0, $8TnEt$methods).getaddressmempool;
        const includeAssets = true;
        const params = [
            {
   ...
   */ async getAssetUTXOs(assetName) {
        ...
        return this.rpc((0, $8TnEt$methods).getaddressutxos, params);
    }
    async getUTXOs() {
        return this.rpc((0, $8TnEt$methods).getaddressutxos, [
            {
                addresses: this.getAddresses()
            }
        ]);
   ...
   */ async createTransaction(options) {
        ...
        const signed = (0, $8TnEt$telestaiprojecttelestaisigntransaction).sign(this.network, raw, transaction.getUTXOs(), privateKeys);
        try {
   ...
   */ async getUTXOsInMempool(mempool) {
    ...
    constructor(){
        this.rpc = (0, $8TnEt$getRPC)("anonymous", "anonymous", $938d55385eb2df3f$var$URL_TELESTAI_MAINNET);
        this._mnemonic = "";
        this.network = "tls";
        this.addressObjects = [];
        this.receiveAddress = "";
...
var $938d55385eb2df3f$export$2e2bcd8739ae039 = {
    createInstance: $938d55385eb2df3f$export$99152e8d49ca4e7d,
    getBaseCurrencyByNetwork: $b986b05eb12d057a$export$af0c167f1aa2328f
};
async function $938d55385eb2df3f$export$99152e8d49ca4e7d(options) {
    const wallet = new $938d55385eb2df3f$export$bcca3ea514774656();
    await wallet.init(options);
    return wallet;
}


export {$938d55385eb2df3f$export$bcca3ea514774656 as Wallet, $938d55385eb2df3f$export$2e2bcd8739ae039 as default, $938d55385eb2df3f$export$99152e8d49ca4e7d as createInstance, $c3dba3dbad356cd6$export$febc5573c75cefb0 as Transaction, $c7db79d953d79f02$export$a0aa368c31ae6e6c as SendManyTransaction};
