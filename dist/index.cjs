var $ghyNu$telestaiprojecttelestairpc = require("@telestai-project/telestai-rpc");
var $ghyNu$telestaiprojecttelestaikey = require("@telestai-project/telestai-key");
var $ghyNu$telestaiprojecttelestaisigntransaction = require("@telestai-project/telestai-sign-transaction");
...
$parcel$export(module.exports, "Wallet", () => $7c7d0d72c7e90f08$export$bcca3ea514774656);
$parcel$export(module.exports, "default", () => $7c7d0d72c7e90f08$export$2e2bcd8739ae039);
$parcel$export(module.exports, "createInstance", () => $7c7d0d72c7e90f08$export$99152e8d49ca4e7d);
...
(0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaisigntransaction))).sign; //"Idiocracy" but prevents bundle tools such as PARCEL to strip this dependency out on build.
...
async function $fdd8716063277f2b$export$322a62cff28f560a(WIF, wallet, onlineMode) {
    const privateKey = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaikey))).getAddressByWIF(wallet.network, WIF);
    const result = {};
    ...
    const signedHex = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaisigntransaction))).sign(wallet.network, rawHex, UTXOs, privateKeys);
...
async function $9b3ed6549b57daad$export$df96cd8d56be0ab1(wallet, addresses) {
    ...
    const balance = await wallet.rpc((0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressbalance, params);
...
const $7c7d0d72c7e90f08$var$URL_TELESTAI_MAINNET = "https://tls-rpc-mainnet.telestai.io/rpc";
const $7c7d0d72c7e90f08$var$URL_TELESTAI_TESTNET = "https://tls-rpc-testnet.telestai.io/rpc";
class $7c7d0d72c7e90f08$export$bcca3ea514774656 {
   ...
   */ sweep(WIF, onlineMode) {
    ...
    async init(options) {
        ...
        let url = $7c7d0d72c7e90f08$var$URL_TELESTAI_MAINNET;
        //VALIDATION
        ...
        if (options.network === "tls-test") url = $7c7d0d72c7e90f08$var$URL_TELESTAI_TESTNET;
        ...
        this.rpc = (0, $ghyNu$telestaiprojecttelestairpc.getRPC)(username, password, url);
        this._mnemonic = options.mnemonic;
        //Generating the hd key is slow, so we re-use the object
        const hdKey = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaikey))).getHDKey(this.network, this._mnemonic);
        const coinType = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaikey))).getCoinType(this.network);
        const ACCOUNT = 0;
        ...
        while(doneDerivingAddresses === false){
            ...
            const tempAddresses = [];
            for(let i = 0; i < 20; i++){
                const external = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaikey))).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/0/${this.addressPosition}`);
                const internal = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaikey))).getAddressByPath(this.network, hdKey, `m/44'/${coinType}'/${ACCOUNT}'/1/${this.addressPosition}`);
    ...
    async hasHistory(addresses) {
        ...
        const asdf = await this.rpc((0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressbalance, [
            obj,
            includeAssets
        ]);
        //@ts-ignore
    ...
    async getHistory() {
        ...
        const deltas = this.rpc((0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressdeltas, [
            {
                addresses: addresses,
                assetName: assetName
            }
    ...
    async getMempool() {
        const method = (0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressmempool;
        const includeAssets = true;
        const params = [
            {
   ...
   */ async getAssetUTXOs(assetName) {
        ...
        return this.rpc((0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressutxos, params);
    }
    async getUTXOs() {
        return this.rpc((0, $ghyNu$telestaiprojecttelestairpc.methods).getaddressutxos, [
            {
                addresses: this.getAddresses()
            }
        ]);
   ...
   */ async createTransaction(options) {
        ...
        const signed = (0, ($parcel$interopDefault($ghyNu$telestaiprojecttelestaisigntransaction))).sign(this.network, raw, transaction.getUTXOs(), privateKeys);
        try {
   ...
   */ async getUTXOsInMempool(mempool) {
    ...
    constructor(){
        this.rpc = (0, $ghyNu$telestaiprojecttelestairpc.getRPC)("anonymous", "anonymous", $7c7d0d72c7e90f08$var$URL_TELESTAI_MAINNET);
        this._mnemonic = "";
        this.network = "tls";
        this.addressObjects = [];
        this.receiveAddress = "";
        ...
        this.baseCurrency = "TLS" //Default is TLS but it could be EVR
        ;
        this.offlineMode = false;
    }
}
var $7c7d0d72c7e90f08$export$2e2bcd8739ae039 = {
    createInstance: $7c7d0d72c7e90f08$export$99152e8d49ca4e7d,
    getBaseCurrencyByNetwork: $e42f6e77e719937d$export$af0c167f1aa2328f
};
async function $7c7d0d72c7e90f08$export$99152e8d49ca4e7d(options) {
    const wallet = new $7c7d0d72c7e90f08$export$bcca3ea514774656();
